  ...
  return (
    <header className="header">
      <div className="header__line-top">
        <span className="header__line-top-logo">
          <svg
            width="71px"
            height="18px"
            viewBox="0 0 71 18"
      ...
      <div className="header__nav">
        <ul className="header__nav-box">
          <li className="header__nav-options header__nav-options--news">NEWS</li>
          <li className="header__nav-options">Top</li>
          <li className="header__nav-options">Local</li>
          <li className="header__nav-options">Covid-19</li>
          <li className="header__nav-options">Climate</li>
          ...
          <li className="header__nav-options">Indigenous</li>
