      ...
      <main className="home">
        <article className="home__content-text">
          ...
          <section className="home__section">
            ...
            <div className="home__content-link">
              ...
              <a
                ...
                rel="noreferrer"
              >
                cryptocurrency auto-trading program called QuantomAI.
              </a>
              {" "}
              <span className="home__text">
          ...
          <section className="home__section">
            ...
            <h3 className="home__title home__title--section">
              WHAT EXACTLY IS QuantomAI AND HOW DOES IT WORK?
            </h3>
            <div className="home__content-link">
          ...
          <section className="home__section">
            <div className="home__picture home__picture--center">
              ...
              <p className="home__img-title">
                Steven Baker used the profits he earned from QuantomAI to
                buy his little brother his dream car. What an inspiring way to
                use wealth for good!
              </p>
            </div>
            <h3 className="home__title home__title--section">
              DOES QuantomAI REALLY WORK? WE TEST IT OUT OURSELVES
            </h3>
            <div className="home__content-link">
              <span className="home__text">
          ...
          >
            ...
            <div className="home__picture home__picture--center">
              ...
              <p className="home__img-title">
                ...
                QuantomAI could relieve his financial pressure, so he
          ...
          >
            ...
            <h3 className="home__title home__title--section">
              HOW TO GET STARTED WITH QuantomAI (LIMITED SPOTS AVAILABLE)
            </h3>
            <div className="home__content-link">
              <span className="home__text">
